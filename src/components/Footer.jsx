const Footer = () => {
  return (
    <div className="bg-gray-900 text-white">
      <footer className="bg-slate-850 py-8">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
            <div className="">
              ...
              <p className="mt-2 text-justify text-sm">
                Website xem phim trực tuyến chất lượng cao, cập nhật phim mới
                nhất vietsub mỗi ngày, xem miễn phí hàng nghìn bộ phim HD/4K đa
                thể loại.
              </p>
            </div>
            <div>
